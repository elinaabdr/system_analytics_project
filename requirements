...
Стейкхолдеры: клиенты, тренеры, аналитики, администраторы, владелец, инвесторы, команда разработки, маркетологи, регуляторы
...
6. Оплата тренировок / абонементов
   ...
   6.3. Возможность вернуть деньги за оставшееся время / кол-во тренировок абонемента
...
2. Интерфейс клиента
   ...
   2.3. Страница выбора абонемента, оплата
   2.4. Профиль (история посещений, краткая информация о себе, информация по абонементу)
   2.5. Настройки
